                ...
                <div class="col-sm-6 p-md-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="javascript:void(0)">Awaiting</a></li>
                            </ol>
                 </div>
            </div>
                <div class="card">
                     ...
                     <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="small_text ox_text"><a href="{{route('detailshow',['id'=>$data->id])}}">{{$data->group_name}}</a></td>
