												...
												<div class="w-100">
													...
													<div class="pb-10 pb-lg-15">
                                                        ...
                                                        <div  style="display:flex; flex:1; justify-content:space-between; align-items:center">
                                                            <h2 > User Role</h2>
                                                            <a href="{{ route('manage_user_account') }}" class="btn btn-primary btn-sm">Back</a>
                                                        </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                            <a href="" class="fs-6 text-gray-800 text-hover-primary">{{$menu->title}}</a>
                                                                                ...
                                                                                @if(DB::table('user_menu')->where('menu_id', $menu->id)->where('user_id', $user->id)->first())
                                                                            <td class="text-end">
                                                                                <a href=" {{ route('remove_user_menu', ['id' => $menu->id, 'user_id' => $user->id]) }} " class="btn btn-danger btn-sm">Remove</a>
                                                                            </td>
                                                                                @else
                                                                            <td class="text-end">
                                                                                <a href="{{ route('add_user_menu', ['id' => $menu->id, 'user_id' => $user->id]) }}" class="btn btn-primary btn-sm">ADD</a>
                                                                            </td>
