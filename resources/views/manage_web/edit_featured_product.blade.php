											...
											<div class="current" data-kt-stepper-element="content">
												...
												<div class="w-100">
													...
													<div class="pb-10 pb-lg-15">
                                                        ...
                                                        <a href="{{ route('featured_product') }}" class="btn btn-primary btn-sm">Back</a>
                                                        </div>
													...
													<div class="fv-row">
                                                        ...
                                                        <form action="{{ route('update_featured_product') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            @method('put')
                                                            <!--begin::Card-->
                                                            <div class="card">
    ...
    <!--                                                                
                                                                    ...
                                                                    <div class="mb-5">
                                                                        ...
                                                                        <select class="form-control form-control form-control-solid" name="product" >
                                                                            <option value="{{$featured->id}}">{{$featured->name}}</option>
                                                                    ...
                                                                    <div class="mb-5">
                                                                        <input type="hidden" value='{{ $featured->f_id }}' name="id">
