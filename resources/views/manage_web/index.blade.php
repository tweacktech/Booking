@extends('layouts.app', ['title' => 'Top Products'])
									...
									<div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper" >
										...
										<div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper" >
                                            <div class="stepper-nav mb-5" style="width:100%;">
                                                ...
                                                <div class="stepper-item" data-kt-stepper-element="nav">
                                                    <a href="{{ route('category_slider') }} "><h3 class="stepper-title">Manage Category Slider</h3></a>
                                                </div>
                                                <div class="stepper-item" data-kt-stepper-element="nav">
                                                    <a href="{{ route('manage_offer_slider') }} "><h3 class="stepper-title">Manage Offer Header</h3></a>
                                                </div>
                                            </div>
                                        </div>
										<!--end::Nav-->
										...
										<div class="mx-auto pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form" style="width:100%;">
											...
											<div class="current" data-kt-stepper-element="content">
                                                ...
                                                <div class="flex-column flex-lg-row-auto w-100 w-lg-250px w-xxl-325px mb-8 mb-lg-0 me-lg-9 me-5" style="height:200px">
                                                    <!--begin::Form-->
                                                    <form action=" {{ route('add_top_product') }} " method="POST" enctype="multipart/form-data">
														@csrf
                                                        <!--begin::Card-->
                                                        <div class="card">
                                                            <!--begin::Body-->
                                                            ...
                                                            <tbody class="fs-6">
                                                               @foreach ($tops as $top)
                                                                   <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ route('edit_top_product_page', ['id' => md5($top->id) ]) }} " class="btn btn-info btn-sm">Edit</a>
                                                                        <a href="{{ route('delete_top_product', ['id' => md5($top->id) ]) }} " class="btn btn-danger btn-sm">Delete</a>
                                                                    </td>
                                                                   </tr>
                                                               @endforeach
                                                            </tbody>
