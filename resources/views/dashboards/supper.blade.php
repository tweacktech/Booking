                                ...
                                <div class="custom-tab-1">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show" id="sale">
                                             <table class="table table-row-dashed table-row align-middle gs-0 gy-4" style="color:white;">
                                        <!--begin::Table head-->
                                        <thead>
                                            <tr class="border-0">
                                                ...
                                                <th class="p-0 min-w-120px">Action Type</th>
                                       ...
                                       <tr>
                                        ...
                                        <td class="text-muted fw-bold" style="color: white;" >{{ $activity->activity}}</td>
                                        <td >
